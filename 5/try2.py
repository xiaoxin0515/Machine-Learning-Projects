...
if __name__ == '__main__':
    ...
    if not train:
        ...
        data_output5 = open('variable/length.pkl', 'wb')
        ...
        data_output3 = open('variable/all_segment.pkl', 'wb')
        pickle.dump(all_segment, data_output3)
        data_output3.close()
        data_output4 = open('variable/score.pkl', 'wb')
        ...
        data_output1 = open('variable/appearance_array.pkl', 'wb')
        pickle.dump(appearance_array, data_output1)
        data_output1.close()
        data_output2 = open('variable/label_result.pkl', 'wb')
    ...
    #########################################
        ...
        data_input1 = open('variable/appearance_array.pkl', 'rb')
        data_all = pickle.load(data_input1)

        data_input1.close()
        data_input2 = open('variable/label_result.pkl', 'rb')
